        ...
        <div>
          ...
          <div class="dateValShow">
            <vs-row justify="space-between">
              <div
                :class="status === 'day' ? ['dateTruePan'] : ['datePan']"
                @click="selectPan('day')"
              >
                <p style="margin-top: 2vh">{{ day }}</p>
              </div>
              <div
                :class="status === 'month' ? ['dateTruePan'] : ['datePan']"
                @click="selectPan('month')"
              >
                <p style="margin-top: 2vh">{{ month }}</p>
              </div>
              <div
                :class="status === 'year' ? ['dateTruePan'] : ['datePan']"
                @click="selectPan('year')"
              >
                <p style="margin-top: 2vh">{{ year }}</p>
              </div>
              <div
                :class="status === 'hour' ? ['dateTruePan'] : ['datePan']"
                @click="selectPan('hour')"
              >
                <p style="margin-top: 2vh">{{ hour }}</p>
              </div>
              <div
                :class="status === 'min' ? ['dateTruePan'] : ['datePan']"
                @click="selectPan('min')"
              >
