        ...
        <div class="mp3List">
          <div class="mp3ListName">
            <vs-row justify="space-between" align="center">
              MP3 List
              <div
                style="margin-right: 0.5vw; font-size: 1.3vw;text-align:start; padding-top:0px; height: 6vh; width: 10vw; background-color: #003355; color: #0073a7;"
              >
                  ...
                  <vs-button style="height: 8vh; width: 7vw; background-color: #003355" square>
                    <vs-col>
                      <font-awesome-icon
                        ...
                        icon="step-backward"
                      ></font-awesome-icon>
                      <div style="color: #0077aa; font-size: 1.3vw">Previous</div>
                    </vs-col>
                  </vs-button>
                </vs-col>
              </vs-col>
